...
RUN mkdir -p /tmp/build/nodejs/lib /tmp/build/nodejs/release /tmp/release && \
  cp /tmp/from-git/duckdb/tools/nodejs/lib/*.js /tmp/build/nodejs/lib && \
  cp /tmp/from-git/duckdb/tools/nodejs/package.json /tmp/build/nodejs/package.json && \
  cp /tmp/from-git/duckdb/tools/nodejs/duckdb.js /tmp/build/nodejs/duckdb.js && \
  cp /tmp/from-git/duckdb/tools/nodejs/build/Release/duckdb.node /tmp/build/nodejs/release/duckdb.node && \
